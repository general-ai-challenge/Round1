...
#
# CommAI-env documentation build configuration file, created by sphinx-quickstart on Wed Aug  3 14:31:58 2016.
...
man_pages = [('index', 'CommAI-env', u'CommAI-env Documentation', [u'Facebook'], 1)]
